 ...
 *              t.{@link #getSymbol getSymbol}().
 *                          {@link #equals(Object) equals("quit")}) break;
 *          // process token
...
public class Token
{
	 ...
	 * Token is a number.
	 */
	static public final int NUMBER_KIND = 1;
	/**
	 * Token is a boolean.
	 */
	static public final int BOOLEAN_KIND = 2;
	/**
	 * Token is a symbol.
	 */
	static public final int SYMBOL_KIND = 3;
	/**
	 * Token is a procedure.
	 */
	static public final int PROCEDURE_KIND = 4;
